...
(() => {
  ...
  const state = {
    ...
    open: new Set(),
    /**
     * Which cards are showing their tree, by card key (`workspace/id`). bc-rfnr.9.2.
     *
  ...
  */
   ...
   * epic is nine of ten or nine of sixty. And it is the honest place to say an epic has
   ...
   * is `underOwnedRoots`'s business, and a bead you filtered out of a tree is still a
  ...
  listEl.addEventListener('click', async (ev) => {
    ...
    /**
     * Open a card's tree, or fold it up. bc-rfnr.9.2.
     *
