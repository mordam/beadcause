...
`public/foundations.js`, `public/term.js` — and nothing in the browser catches an
...
The daemon used to be no better, and was worse for being unwatched: it now catches its
own — see [the daemon reports itself](#and-the-daemon-reports-itself-through-the-same-door)
below. The browser half is still owed.
