  ...
  const handler = async (req, res) => {
    ...
    try {
      ...
      if (p === '/api/respond' && req.method === 'POST') {
        ...
        // after bc-ko7n: `runClose` recovers from the assignee/actor mismatch by
        // dropping the claim, which is not one of the refusals this gate reports and
        // never reaches the phone at all.
