 ...
 * kinds of line to the tracker, and — since bc-6sqs — moves one ref on this laptop:
 *
 ...
 */
export async function reconcileLanded(bd, ws, dir, { base = 'main', limit = PAGE_LIMIT, rows = null, now = Date.now(), land = landLocally } = {}) {
  const out = { ok: false, reason: '', checked: 0, closed: [], cards: [], skipped: [], truncated: null, landed: null };
