 ...
 *
 * The two labels themselves live in lib/approvallabels.js, alongside the rest of the
 * vocabulary lib/approvalcard.js draws from — this file re-exports them so nothing
 * importing `GATE_LABEL` from here had to change. See that file for why they are a
 * third module rather than one importing the other.
 */
import { GATE_LABEL, NEEDS_APPROVAL } from './approvallabels.js';

export { GATE_LABEL, NEEDS_APPROVAL };
