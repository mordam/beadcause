...
/**
 * What no advocate queue may contain: questions are yours rather than its, and a held
 * bead is nobody's yet. Passed at the call site in lib/advocate.js so the survey reads
 * truthfully, *and* forced on by `Bd.ready` so a caller cannot ask for held work.
 */
export const QUEUE_EXCLUDED = ['human', UNENDORSED];
