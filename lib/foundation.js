...
export function claudeArgs(foundation, { systemFile = null, addDirs = [] } = {}) {
  ...
  // Repeated rather than comma-joined: `--add-dir` takes one path per occurrence, and a
  // checkout whose path contains a comma would otherwise become two directories neither
  // of which exists.
