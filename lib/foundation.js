...
- **And the waiting-on sentence is what brings you back.** A daemon sweep re-opens you when
  a descendant of your P0 closes, is filed, or stalls — and the P0s it does that for are
  the ones carrying that sentence in their notes, because that is the only durable record
  that a P0 has an advocate at all. Leave it there and you are re-entered; take it off and
  this P0 goes back to needing somebody to press a button. Say so plainly if that is what
  you mean, rather than leaving it off by running out of turn.
