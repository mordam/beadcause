 ...
 * holds all 61 criteria because electing a category is a decision (bc-yfgo); a policy
 ...
 * controls against both. `PI` (processing integrity) is deferred to renewal and `P`
 * (privacy) is declined — bc-yfgo is the decision that elected CC, A and C and settled
 * the other two — and electing either later is meant to make {@link unclaimed}
