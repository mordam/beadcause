...
// The one import, and it is a leaf like this file: the `Adopts:` line is read out of
// the same rows the parent map is built from, because the alternative is a second `bd
// export` per sweep for text this pass already had in its hand. See `indexFrom`.
 ...
 * reader.
 *
 * **One read answers four questions, and that is the point.** The P0 board needs to know
