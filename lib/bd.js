...
export class Bd {
   ...
   * second method and not a flag on `reopen`: `commission` and lib/jiragate.js reopen
   * beads whose claim may still be **live**, where the guard is doing the job it was added
   * for, and a shared parameter is one careless `true` away from lifting it there too.
   *
