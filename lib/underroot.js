 ...
 * nothing back.
 *
 * Rides the identical door as lib/endorse.js's `assertEndorsed` in every one of
 * lib/session.js's launchers, one line below it — this is one of the places that decide
 * whether something may run with nobody watching, and lib/authority.js is the map of
 * all of them (it names this file as the one the bead that asked for that map missed).
 */
