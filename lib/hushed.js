 ...
 * `'addressed'`, `'filtered'` or `'muted'`. That answer reaches the server log and the
...
/** The three answers `quietReasonFor` can give. Anything else is not a kind of quiet. */
const REASONS = new Set(['addressed', 'filtered', 'muted']);
