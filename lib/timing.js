 ...
 * `foundation:<ws>` and `agentbeads:<ws>`, once each per workspace, and with eleven
 * workspaces on one Mac that is thirty writes to a single scalar of which the last one
 * home won. Measured on the live daemon 2026-08-17, that produced three log lines
