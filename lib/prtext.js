 ...
 */
export function footer({ beadId, beadTitle = '', owner = 'the owner', autoMerge = false, requireApproval = false, editHold = false }) {
...
export function prBody({
  ...
  const blocks = [
    ...
    '---',
    footer({ beadId, beadTitle, owner, autoMerge, requireApproval, editHold }),
  ];
