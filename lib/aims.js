...
export const ROLES = Object.freeze([
  ...
  Object.freeze({
    ...
    // `residual-risk-acceptance` is here as well as on top management because Clause
    // 6.1.3 asks the *risk owner* to accept the residual, and the owner of an AI risk is
    // usually the owner of the system it arises in. `lib/risk.js` decides which band
    // needs whose signature; this only says the role is capable of giving one.
    mayApprove: Object.freeze(['agent-protocol-amendment', 'residual-risk-acceptance']),
  }),
  Object.freeze({
    id: 'impact-approver',
