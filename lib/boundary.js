...
const CLIMATIVE = {
   ...
   * oversight: see the census. The seven agent roles are enumerated individually because
  ...
  components: [
    ...
    ...[
      ...
      ['epic-advocate', 'the Epic Advocate', 'plans one owned epic, files its children and carries them to release'],
      ...
      ['review-advocate', 'the pull request reviewer', 'reads a delivered pull request and says what has to change before it may merge'],
    ].map(([id, title, does]) => ({
      id: `agent-${id}`,
      kind: 'role',
  ...
  census: {
    ...
    role: {
      ...
      note:
        'The seven carved-out agent roles are enumerated in full because this repository mints them. ' +
