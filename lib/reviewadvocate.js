 ...
 *   scarce spends it.
 * - **Not the approving review on GitHub.** Which identity may approve is bc-0cop, and
 *   submitting it is bc-36xx.3/bc-36xx.8. This agent has no `gh pr review` grant, and the
 *   brief says why.
 */
 ...
 * here is what stops a review appearing under Adam's name on a repo he never read the diff
 * of. A verdict shown without that line is a person's approval as far as anyone can tell.
 */
