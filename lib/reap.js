 ...
 * - **The bead named in that name has to be closed**, which is guard 1 again and is
 *   the guard that does most of the work here. A hand-run session named after a bead
 *   that is still open — the case this widening actually risks — is untouchable.
 *
