...
const GLOBAL_DEFAULT = {
   ...
   * - **The downmerge is usually trivial here.** With the four registries union-merged
   *   (bc-8479e) 30 of 34 open branches merge onto `main` with no conflict at all, and the
   *   downmerge is git keeping both sides of an appended line. Paying a full gate run to
   *   re-prove a one-line list append is the cost this removes.
   *
