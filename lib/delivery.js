 ...
 * you: a refusal that happened outranks a policy that stopped one happening, and both
 * outrank a worker's own hesitation.
 */
export function deliveryBody(d, { context = '', refused = '', approval = false, asked = false, ship = '' } = {}) {
  const parts = [];
