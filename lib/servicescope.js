...
export const CONTROLS = Object.freeze([
  ...
  },
  {
    ...
    bead: 'bc-3muu.5',
    how:
      'Making a silent or modified instance a finding is bc-3muu.5, and nothing in this release detects one. The ' +
      'severity, clock and post-incident review such a finding would then owe have landed in lib/incident.js ' +
      '(bc-4r10.9), so what is missing here is the detection rather than the response.',
  },
  {
    id: 'SOC2.CC7.4',
    why:
    ...
    bead: 'bc-3muu.10',
    how:
      'Incident response for the programme landed with bc-4r10.9: a closed severity vocabulary, a commitment ' +
      'stated in advance, a clock read off the bead and a post-incident review that is owed rather than ' +
      'remembered. What is still owed is the part peculiar to this control: the anchor receipts that would ' +
      'survive a compromised witness are bc-3muu.10, and until they exist the response to a compromised evidence ' +
      'store still has to consult the evidence store.',
  },
  {
    id: 'SOC2.CC8.1',
    why:
