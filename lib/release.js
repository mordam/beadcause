 ...
 *    ten minutes have to be one deploy — which is what pressing Ship does today. What
 *    closing the window ships is the commit the branch was at *when it closed*, recorded
 *    with the stamps below: see `pinFor`.
 ...
 * - **Ready and armed, window elapsed** fires, once, on the commit the branch is at
 *   *now* — see `pinFor`. What lands after this instant is the next batch's, and
 *   pinning is what makes that a fact about the deploy rather than about the intent.
 *
