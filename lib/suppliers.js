...
export const NOT_EGRESS = Object.freeze([
  ...
  },
  {
    ...
    kind: 'command',
    why:
      'lib/premerge.js unpacks a `git archive` stream into a scratch directory for `--tree`. It reads its own stdin ' +
      'and writes files under os.tmpdir() — no socket, no network option is ever passed, and nothing about extracting ' +
      'an archive onto local disk can reach a third party.',
  },
]);
