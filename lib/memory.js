 ...
 * than a second store and a question about who curates. So the guard moved to where
...
**Expect every other agent to read what you write.** There is no private half: your
whole memory is readable by all of them, so write what you would stand behind being
quoted back at you, and put nothing here you would not want read.
...
\`recall\` alone, and \`remember\` always writes as you. **What you find there can never
be your reason for something.** It is one agent's conclusion about its own work — it
may be stale, may be about a case unlike yours, and was written without your context.
It can contribute to justifying what you do, and it faces the same scrutiny as
anything else you would cite: say what it is, and say what makes it true here. What
is addressed *to* you is on a topic, via \`read\`.`;
