 ...
 */
export const MEMORY_BRIEF = `**You have a memory, and it outlives this run.** It follows *you* — the same agent
...
how Adam likes a thing shaped, an approach that worked, a dead end not worth walking
again. **Anything with a work item attached belongs on a bead, not here**, and if you
