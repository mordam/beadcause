...
export const REGISTER = Object.freeze([
  ...
  {
    id: 'risk-register',
    title: 'The AI risk method, criteria and register — with a review date on every rating',
    path: 'lib/risk.js',
    section: null,
    owner: 'Adam Morgan',
    approvedBy: 'Adam Morgan',
    ...
    reviewMonths: 6,
    serves:
      'ISO/IEC 42001 Clause 6.1.2 and 6.1.3, and ISO/IEC 23894 — the documented AI risk method, the acceptance criteria, ' +
      'and the register of risks with their treatment and their residual.',
    why:
      'A rating is a statement about a system on the day it was made, and this system changes daily; a register nobody ' +
      're-rates describes a machine that no longer exists, and every treatment a Statement of Applicability cites rests ' +
      'on it. Six months rather than twelve for that reason. Note what is approved here: the method and the register, by ' +
      'the owner of this repository — and not the residuals, every one of which separately records that its acceptance ' +
      'is still owed.',
  },
]);
